...
export default {
    ...
    execute: async (sock, chat, m) => {
        try {
            ...
            const bannerUrl = global.banner || settings.banner || 'https://litter.catbox.moe/mjtxin.jpg'
            const webUrl = 'https://moonstaff.onrender.com/'
            ...
            Object.keys(categorias).sort().forEach(key => {
                ...
                texto += `┌── ⟖ *${cat.nombre.toUpperCase()}* [${cat.cmds.length}]\n`
            ...
            await sock.sendMessage(chat, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: settings.canalId || '120363000000000000@newsletter',
                        newsletterName: `INFINITY CLUB - official`,
                        serverMessageId: -1
                    },
                    externalAdReply: {
                        title: 'INFINITY CLUB',
                        body: 'INFINITY CLUB | By Dev leo',
